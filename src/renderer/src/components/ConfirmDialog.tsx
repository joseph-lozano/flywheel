...
export default function ConfirmDialog(props: ConfirmDialogProps) {
  ...
  return (
    <div
      ...
      onKeyDown={handleKeyDown} tabIndex={-1} ref={(el) => el.focus()}
    >
      <div style={{
        ...
        <p style={{ color: '#e0e0e0', margin: '0 0 20px 0', 'font-size': '14px', 'line-height': '1.5' }}>
          Process <code style={{ background: '#1a1a2e', padding: '2px 6px', 'border-radius': '3px', color: '#f59e0b' }}>{props.processName}</code> is running. Close anyway?
        </p>
